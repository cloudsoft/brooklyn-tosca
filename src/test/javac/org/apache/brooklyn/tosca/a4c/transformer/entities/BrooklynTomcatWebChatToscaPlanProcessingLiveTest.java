...
public class BrooklynTomcatWebChatToscaPlanProcessingLiveTest extends AbstractAlien4CloudToscaTest{

    @Test
    public void testBrooklynToscaProcessing() {
        String plan = new ResourceUtils(this).getResourceAsString("classpath://" + "templates/tomcat-template-webchat.yaml");
        ...
        appSpec.location(resolveLocationFromString("aws-ec2:eu-west-1"));
        ...
        assertTrue(tomcat.getAttribute(VanillaSoftwareProcess.SERVICE_PROCESS_IS_RUNNING));
